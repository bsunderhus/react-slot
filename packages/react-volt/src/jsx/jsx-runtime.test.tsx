...
describe("createElement with getSlotsNext", () => {
  ...
  describe("custom behavior tests", () => {
    it('keeps children from "defaultProps" in a render callback', () => {
      ...
      expect(children).toHaveBeenCalledWith("div", {
    ...
    it("keeps children from a render template in a render callback", () => {
      ...
      const TestComponent = (props: TestComponentProps) => {
        const state: TestComponentState = {
          ...
          // eslint-disable-next-line deprecation/deprecation
          inner: resolveShorthand(props.inner, {
            defaultProps: { id: "inner" },
          }),
          // eslint-disable-next-line deprecation/deprecation
          outer: resolveShorthand(props.outer, {
            defaultProps: { id: "outer" },
          }),
        };
        // eslint-disable-next-line deprecation/deprecation
        const { slots, slotProps } = getSlotsNext<TestComponentSlots>(state);
    ...
    it("keeps children from a render template in a render callback", () => {
      ...
      const TestComponent = (props: TestComponentProps) => {
        const state: TestComponentState = {
          ...
          inner1: slot.always(props.inner1, {
            defaultProps: { id: "inner-1" },
            elementType: "div",
          }),
          inner2: slot.always(props.inner2, {
            defaultProps: { id: "inner-2" },
            elementType: "div",
          }),
          outer: slot.always(props.outer, {
            defaultProps: { id: "outer" },
            elementType: "div",
          }),
        };
